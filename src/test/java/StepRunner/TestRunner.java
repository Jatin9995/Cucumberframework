...
@CucumberOptions(
	features = "J:\\eclipse_Jdrive\\Cucumberframework\\src\\test\\java\\FeatureFile\\Login.feature",
...
//tags="@Sanity or @regression" will run scenarious tagged with sanity or regression//sabhi scemarios execute ho jayenge because saare scenarios  pe tag laga hai feaure file me
		...
		//features = {"J:\eclipse_Jdrive\Cucumberframework\src\test\java\FeatureFile\Login.feature", "J:\\eclipse_Jdrive\\Cucumberframework\\src\\test\\java\\FeatureFile\\Customer.feature"}, // agar sabhi feature files ko sath me execute karna hai to feature file k folder ka location dete hai.
		glue = {"StepDefinition"},
		dryRun = false,
		monochrome = true,
		tags="@Sanity",
		plugin = {"pretty","html:J:\\eclipse_Jdrive\\Cucumberframework\\target\\Report\\succesfulLogin.html",
				"json:J:\\eclipse_Jdrive\\Cucumberframework\\target\\Report\\succesfulLogin.json",
				"junit:J:\\eclipse_Jdrive\\Cucumberframework\\target\\Report\\succesfulLogin.xml"}
